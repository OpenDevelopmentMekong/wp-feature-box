...
* API: Added `$format_value` parameter to the `wpfbox_get_fields` function
...
* API: Fixed bug with wpfbox_get_fields function preventing values to be returned from options page and taxonomy terms
...
= 4.3.0 =
* Core: wpfbox_get_field can now be used within the functions.php file
...
* [Fixed] Fix issue where wpfbox_get_field_object returns the wrong field when using WPML
...
* [Added] Add function wpfbox_get_field_groups()
...
* [Added] Add new parameter to wpfbox_get_field to allow for no formatting - http://support.advancedcustomfields.com/discussion/3188/update_field-repeater
...
* [Added] Add filter "acf_load_value" for values - http://support.advancedcustomfields.com/discussion/3725/a-filter-for-wpfbox_get_field
...
* [Updated] Allow wpfbox_get_field to use field_key or field_name
...
* [Updated] Update wpfbox_get_field_object function to allow for field_key / field_name + option to load_value
...
* [Added] Allow "options" as post_id for wpfbox_get_fields - http://support.advancedcustomfields.com/discussion/1926/3-1-8-broke-wpfbox_get_fields-for-options
...
* [Added] Add new function wpfbox_get_field_object to API - http://support.advancedcustomfields.com/discussion/290/field-label-on-frontend
...
* [Fixed] wpfbox_get_field returning false for 0 - http://advancedcustomfields.com/support/discussion/2115/wpfbox_get_field-returns-false-if-field-has-value-0
...
* Performance: Added caching to the wpfbox_get_field function. Templates will now render quicker.
...
* API update: wpfbox_get_field($repeater) will return an array of values in order, or false (like it used to!)
* Radio Button: added labels around values
* Post object + Page Link: select drop down is now hierarchal
* Input save errors fixed
* Add 'return_id' option to wpfbox_get_field / get_sub_field
* Many bug fixes

= 2.1.3 =
* Fixed API returning true for repeater fields with no data
* Added wpfbox_get_fields back into the api!
...
= 1.0.1 =
* New Api Functions: wpfbox_get_fields(), wpfbox_get_field(), the_field()

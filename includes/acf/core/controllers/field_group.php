...
class acf_field_group
{
	...
	*/
	...
	function __construct()
	{
		...
		// filters
		add_filter('acf/wpfbox_get_field_groups', array($this, 'wpfbox_get_field_groups'), 1, 1);
		add_filter('acf/field_group/wpfbox_get_fields', array($this, 'wpfbox_get_fields'), 5, 2);
	...
	*/
	...
	function wpfbox_get_field_groups( $array )
	{
		// cache
		$found = false;
	...
	*/
	...
	function wpfbox_get_fields( $fields, $post_id )
	{
		// global
		global $wpdb;
